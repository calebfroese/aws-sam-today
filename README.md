...
This is a sample template for aws-sam-today - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name aws-sam-today --query 'Stacks[].Outputs'
```
